...
<div class="map_wrap">
    ...
    <div id="menu_wrap" class="bg_white">  
		...
		<a class="item" onclick="location.href=`${pageContext.request.contextPath}/sclmain/mapMypage`">
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=1aef10108def276437df95d26ab8399f&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
