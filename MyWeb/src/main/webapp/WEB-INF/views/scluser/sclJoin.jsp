    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-9 col-sm-12 join-form">
                ...
                <form action="${pageContext.request.contextPath}/scluser/join" method="post" name="joinForm">
                    <div class="form-group">
                        <!--사용자클래스선언-->
                        <label for="id">아이디</label>
                        <div class="input-group">
                            <!--input2탭의 input-addon을 가져온다 -->
                            <input type="text" class="form-control" name="sclId" id="sclId" placeholder="아이디를 (영문포함 8~12자 이상)">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="sclPw" class="form-control" id="sclPw"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sclName" class="form-control" id="sclName" placeholder="이름을 입력하세요.">
                    </div>
                    <!--input2탭의 input-addon을 가져온다 -->
                    <div class="form-group">
                        <label for="hp">휴대폰번호</label>
                        <div class="input-group">
                            <select name="sclPhone1" class="form-control phone1" id="sclPhone1">
                                <option>010</option>
                                <option>011</option>
                                <option>017</option>
                                <option>018</option>
                            </select>
                            <input type="text" name="sclPhone2" class="form-control phone2" id="sclPhone2" placeholder="휴대폰번호를 입력하세요.">
                        </div>
                    </div>
                    <div class="form-group email-form">
                        <label for="email">이메일</label><br>
                        <div class="input-group">
                            <input type="text" name="sclEmail1" class="form-control" id="sclEmail1" placeholder="이메일">
                            <select name="sclEmail2" class="form-control" id="sclEmail2">
...
<script>
    ...
    document.getElementById('idCheckBtn').onclick = function () {
        ...
        const sclId = document.getElementById('sclId').value;
        ...
        */
        ...
        fetch('${pageContext.request.contextPath}/scluser/id/' + sclId)
            ...
            .then(data => { //텍스트 데이터만 담긴 Promise 객체로부터 data를 전달받음.
                if (data === 'ok') {
                    ...
                    document.getElementById('sclId').setAttribute('readonly', true);
                    ...
                    document.getElementById('sclId').value = ''; //입력칸 비우기
                    document.getElementById('sclId').focus(); //입력칸에 포커싱.
                }
            });
    ...
    document.getElementById('mail-check-btn').onclick = function() {
        const email = document.getElementById('sclEmail1').value + document.getElementById('sclEmail2').value;
        console.log('완성된 email: ', email);
        fetch('${pageContext.request.contextPath}/scluser/email', {
            method: 'post',
            headers: {
    ...
    document.querySelector('.mail-check-input').onblur = function(e) {
        ...
        if(inputCode === code) {
            ...
            document.getElementById('sclEmail1').setAttribute('readonly', true);
            document.getElementById('sclEmail2').setAttribute('readonly', true);
            ...
            //항상 2개 같이 쓰셔야 합니다.
            const $email2 = document.getElementById('sclEmail2');
    ...
    document.getElementById('joinBtn').onclick = function() {
        if(idFlag && pwFlag) {
            if(!document.getElementById('sclId').getAttribute('readonly')) {
    ...
    /*아이디 형식 검사 스크립트*/
    var id = document.getElementById("sclId");
    id.onkeyup = function () {
        /*
            자바스크립트의 정규표현식 입니다.
        ...
        */
        ...
        if (regex.test(document.getElementById("sclId").value)) {
            document.getElementById("sclId").style.borderColor = "green";
            document.getElementById("msgId").innerHTML = "아이디 중복 체크는 필수 입니다";
            idFlag = true;
        } else {
            document.getElementById("sclId").style.borderColor = "red";
    ...
    /*비밀번호 형식 검사 스크립트*/
    var pw = document.getElementById("sclPw");
    pw.onkeyup = function () {
        var regex = /^[A-Za-z0-9+]{8,16}$/;
        if (regex.test(document.getElementById("sclPw").value)) {
            document.getElementById("sclPw").style.borderColor = "green";
            document.getElementById("msgPw").innerHTML = "사용가능합니다";
            pwFlag = true;
        } else {
            document.getElementById("sclPw").style.borderColor = "red";
    ...
    pwConfirm.onkeyup = function () {
        var regex = /^[A-Za-z0-9+]{8,16}$/;
        if (document.getElementById("pwConfirm").value == document.getElementById("sclPw").value) {
