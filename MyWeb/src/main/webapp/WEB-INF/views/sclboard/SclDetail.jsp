        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form action="${pageContext.request.contextPath}/sclboard/modPage" method="post">
                            <div>
                                <label>DATE</label>
                                <p>${article.date}</p>
                            </div>   
                            ...
                            <button type="button" class="btn btn-dark" onclick="location.href='${pageContext.request.contextPath}/sclboard/sclList?pageNo=${p.pageNo}&amount=${p.amount}&keyword=${p.keyword}&condition=${p.condition}'">목록</button>
                    </form>
                </div>
            </div>
        </div>
