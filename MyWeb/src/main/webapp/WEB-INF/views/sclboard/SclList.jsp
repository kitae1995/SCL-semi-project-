        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9 col-xs-12 board-table">
                    ...
                    <!--form select를 가져온다 -->
            <form action="${pageContext.request.contextPath}/sclboard/SclList">
	    		<div class="search-wrap">
                        ...
                        <tbody>
                        	<c:forEach var="vo" items="${boardList}">
	                            <tr>
	                                <td>${vo.bno}</td>
	                                <td>
	                                	<a href="${pageContext.request.contextPath}/sclboard/content?bno=${vo.bno}&pageNo=${pc.page.pageNo}&amount=${pc.page.amount}&keyword=${pc.page.keyword}&condition=${pc.page.condition}">${vo.title}</a>
	                                </td>
	                                <td>${vo.writer}</td>
	                                <td>${vo.date}</td>
	                            </tr>
                    ...
                    <!--페이지 네이션을 가져옴-->
		    <form action="${pageContext.request.contextPath}/sclboard/SclList" name="pageForm">
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-info" onclick="location.href='${pageContext.request.contextPath}/sclboard/SclRegist'">글쓰기</button>
                </div>
