    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form action="${pageContext.request.contextPath}/sclboard/modify" method="post" name="updateForm">
        ...
        <script>
            ...
            document.getElementById('list-btn').onclick = function() {
                location.href='${pageContext.request.contextPath}/sclboard/SclList';
            }
            ...
            document.getElementById('del-btn').onclick = () => {
                if(confirm('정말 삭제하시겠습니까?')) {
                    $form.setAttribute('action', '${pageContext.request.contextPath}/sclboard/delete');
                    $form.submit();
                } 
            }
