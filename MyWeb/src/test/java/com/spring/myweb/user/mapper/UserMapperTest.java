...
public class UserMapperTest {
	...
	@Test
	@DisplayName("회원 가입을 진행했을 때 회원가입이 성공해야 함")
	void registTest() {
	...
	@Test
	@DisplayName("존재하는 회원 아이디를 조회 했을 시 1이 리턴되어야 함")
	void checkIdTest() {
		String id = "abc1234";
	...
	@Test
	@DisplayName("존재하는 회원 아이디를 입력 했을 시 그 회원의 비밀번호가 리턴 되어야 함")
	void loginTest() {
		String id = "abc1234";
