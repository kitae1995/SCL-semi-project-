...
<body>
	...
	<script>
        ...
        $ul.addEventListener('click', function(e) {
            // ul로 함수를 걸어놔서 ul 모서리를 클릭해도 함수가 켜짐
            // 이벤트가 발생한 주체가 del-btn 클래스를 가진 a 태그가 아니라면? 함수 종료시켜버림           
            ...
            if(confirm('정말 삭제하시겠습니까?')){
                //삭제 진행
                //location.href == sendRedirect() 원하는 페이지로 이동시킴
                location.href = e.target.getAttribute('href');  // 여기서 e.target은 del-btn의 a태그임 
                //즉 del-btn의 a태그가 가지고있는 주소로 이동한다는 것
            }else{
                return; // 삭제취소
            }
